...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        LSFT(KC_A),     LCTL_T(KC_S),   LALT_T(KC_D),  LGUI_T(KC_F),  KC_G,                            KC_H,          RGUI_T(KC_J),      RALT_T(KC_K),      RCTL_T(KC_L),    RSFT_T(KC_SCLN),
        KC_Z,           KC_X,           KC_C,          KC_V,          KC_B,                            KC_N,          KC_M,              KC_COMMA,          KC_DOT,          KC_SLSH,
        KC_CAPS,        KC_ESC,         KC_DEL,        LT(1,KC_BSPC), KC_MUTE, KC_MS_BTN1, KC_MS_BTN2, LT(2,KC_SPC),  LT(3,KC_ENT),      SCRL_MO,           ANY(KC_CAD),     OSM(MOD_HYPR)
    ),
    [_FN1] = LAYOUT(
        ...
        _______,        _______,        _______,       _______,       _______,                         KC_PAST,       KC_1,              KC_2,              KC_3,            _______,
        _______,        _______,        _______,       _______,       _______, _______,    _______,    _______,       KC_0,              _______,           KC_PDOT,         KC_PEQL
    ),
    [_FN2] = LAYOUT(
